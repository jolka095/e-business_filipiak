...
*/
  ...
  def addProduct = Action.async{ implicit request =>
    ...
    productForm.bindFromRequest.fold(
      ...
      product => {
        productsRepo.create(product.name, product.keyword, product.category, product.price, product.imageUrl).map { _ =>
 ...
 */
case class CreateProductForm(name: String, keyword: String, category: Int, price: Int, imageUrl: String)
